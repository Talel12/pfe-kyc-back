...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    detail: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::detail.detail'
    >;
    face: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::face.face'
    >;
    id_card: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::id-card.id-card'
    >;
...
export interface ApiFaceFace extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::face.face', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::face.face', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiIdCardIdCard extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::face.face': ApiFaceFace;
      'api::id-card.id-card': ApiIdCardIdCard;
